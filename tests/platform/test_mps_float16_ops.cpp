...
// Mirrors tests/universal/test_cpu_float16_ops.cpp, but runs against the real
// MPSGraph backend, which computes Float16 natively (no Float32 decode step).

TEST(MpsFloat16Ops, Add)
{
